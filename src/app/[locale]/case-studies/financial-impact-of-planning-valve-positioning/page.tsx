...
export default function FinancialImpactOnWellDowntime() {
	const t = useTranslations("CaseStudy2");
				...
				<div
					...
					dangerouslySetInnerHTML={{
						__html: t.raw("content", {
							a: (chunks) =>
								`<a href="https://ogst.ifpenergiesnouvelles.fr/articles/ogst/full_html/2020/01/ogst200156/ogst200156.html" class="text-blue-600 hover:text-black">${chunks}</a>`,
						}),
					}}
				/>
			</div>
