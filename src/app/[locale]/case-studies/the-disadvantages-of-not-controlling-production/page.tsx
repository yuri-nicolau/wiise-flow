...
export default function AvoidingCatastrophesWithBetterModels() {
	const t = useTranslations("CaseStudy4");
			...
			<div className="w-full bg-card padding">
				<div
					...
					dangerouslySetInnerHTML={{
						__html: t.raw("content", {
							a: (chunks) =>
								`<a href="https://www.researchgate.net/publication/348188528_A_Review_of_Exploration_Development_and_Production_Cost_Offshore_Newfoundland" class="text-blue-600 hover:text-black">${chunks}</a>`,
						}),
					}}
				/>
			</div>
